...
const projectLibs = [
  ...
  {pattern: nodeModules + 'mydatepicker/' + jsPattern, included: false, watched: false},
  {pattern: nodeModules + 'mydatepicker/' + mapPattern, included: false, watched: false},

  {pattern: nodeModules + 'ngx-bootstrap/' + jsPattern, included: false, watched: false},
  {pattern: nodeModules + 'ngx-bootstrap/' + mapPattern, included: false, watched: false},

  {pattern: nodeModules + 'ng2-select/' + jsPattern, included: false, watched: false},
  {pattern: nodeModules + 'ng2-select/' + mapPattern, included: false, watched: false},

  {pattern: nodeModules + 'ramda/dist/' + jsPattern, included: false, watched: false},

  {pattern: nodeModules + 'moment/' + jsPattern, included: false, watched: false},
];
